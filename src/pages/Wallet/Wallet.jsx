...
import WalletAddress from '../../containers/WalletAddress/WalletAddress.jsx'
import DashboardWrapper from '../../containers/DashboardWrapper/DashboardWrapper.jsx'
import * as Styles from './wallet.js'
import WalletAssetItem from '../../components/WalletAssetItem/WalletAssetItem.jsx'
...
import { ALGORAND, networkDataToReturn, RIPPLE } from '../../constants/network.js'
import useTabs from '../../Hooks/Tabs.js'
import { NORMAL_TXN, SCHEDULED_TXN } from './constants.js'
import NormalTxn from './tabs/NormalTxn.jsx'
import ScheduledTxn from './tabs/ScheduledTxn.jsx'
import Ripple from './ripple/Ripple.jsx'
import { getActiveAlgorandWallet, getAlgorandHoldings } from '../../app/algorand/algorandSlice.js'
